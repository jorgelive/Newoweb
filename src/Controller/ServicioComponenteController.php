...
class ServicioComponenteController extends AbstractController
{
    ...
    #[Route('/porserviciodropdown/{servicio}', name: 'app_servicio_componente_porserviciodropdown', defaults: ['servicio' => null])]
    ...
    #[Route('/ajaxinfo/{id}', name: 'app_servicio_componente_ajaxinfo', defaults: ['id' => null])]
