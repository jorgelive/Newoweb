...
namespace App\Oweb\Block;

use App\Oweb\Entity\CotizacionCotservicio;
use App\Oweb\Entity\CotizacionFiledocumento;
use App\Oweb\Entity\ReservaReserva;
use App\Oweb\Entity\ViewCotizacionCotcomponenteAlerta;
...
class TareasBlockService extends AbstractBlockService
{
    ...
    public function configureSettings(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'url' => false,
            'title' => 'Tareas',
            'template' => 'oweb/block/tareas.html.twig',
            'class' => 'Tareas',
            'icon' => false,
    ...
    public function execute(BlockContextInterface $blockContext, Response $response = null): Response
    {
        ...
        $componenteAlertas = $this->entityManager->getRepository(ViewCotizacionCotcomponenteAlerta::class)->findAll();
        ...
        $qb = $this->entityManager->createQueryBuilder();
        $qb->select('cs')
            ->from(CotizacionCotservicio::class, 'cs')
