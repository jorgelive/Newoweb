...
/**
 * Decorador del DataSource de Oweb usado exclusivamente en EXPORTACIONES.
 *
 * Objetivo:
 ...
 *
 * Contexto de uso:
 * - Es invocado automáticamente por Oweb Admin al exportar (CSV/XLS),
 *   no se llama manualmente desde ningún Admin ni Controller.
 */
class AdminDecoratingDataSource implements DataSourceInterface
{
    /**
     * DataSource original de Oweb (inyectado como .inner mediante decorates)
     */
