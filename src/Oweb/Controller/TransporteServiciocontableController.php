...
class TransporteServiciocontableController extends CRUDController
{
    ...
    function facturarAction()
    {
        ...
        $solicitud['items'][0]['codigo'] = $this->container->get('App\Oweb\Service\MainVariableproceso')->sanitizeString($object->getServicio()->getNombre(), '_', '[\s+]' );
        $filesString = '';
        ...
        $object->setEstadocontable($em->getReference('App\Oweb\Entity\TransporteEstadocontable', 3));
