...
use App\Oweb\Entity\ReservaUnitnexo;
...
class ReservaUnitnexoController extends CRUDController
{
    ...
    public function icalAction(Request $request = null): Response
    {
        ...
        $calendar = $this->icalGenerator->setTimezone('America/Lima')->setProdid('-//OpenPeru//ReservaUnitNexo Calendar //ES')->createCalendar();
