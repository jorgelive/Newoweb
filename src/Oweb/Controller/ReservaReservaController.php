...
class ReservaReservaController extends CRUDController
{
    ...
    public function resumenAction(Request $request = null): Response|RedirectResponse
    {
        ...
        return $this->render('oweb/admin/reserva_reserva/show.html.twig', [
            'object'                     => $object,
            'action'                     => 'resumen',
    ...
    public function clonarAction(Request $request): Response
    {
        ...
        $newObject->setChannel($this->entityManager->getReference('App\Oweb\Entity\ReservaChannel', ReservaChannel::DB_VALOR_DIRECTO));
        $newObject->setEstado($this->entityManager->getReference('App\Oweb\Entity\ReservaEstado', ReservaEstado::DB_VALOR_CONFIRMADO));
...
TXT;
    ...
    public function icalAction(Request $request = null): Response
    {
        ...
        $calendar = $this->icalGenerator->setTimezone('America/Lima')->setProdid('-//OpenPeru//ReservaReserva Calendar //ES')->createCalendar();
