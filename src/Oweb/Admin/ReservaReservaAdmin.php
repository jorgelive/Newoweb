...
class ReservaReservaAdmin extends AbstractSecureAdmin
{
    ...
    {
        $entityManager = $this->getModelManager()->getEntityManager('App\Oweb\Entity\ReservaReserva');
    ...
    protected function configureListFields(ListMapper $listMapper): void
    {
        $listMapper
            ...
            ->add('unit', FieldDescriptionInterface::TYPE_CHOICE, [
                ...
                'label' => 'Alojamiento',
                'editable' => true,
                'class' => 'App\Oweb\Entity\ReservaUnit',
                'required' => true,
                'choices' => [
            ...
            ->add('estado', FieldDescriptionInterface::TYPE_CHOICE, [
                ...
                'label' => 'Estado',
                'editable' => true,
                'class' => 'App\Oweb\Entity\ReservaEstado',
                'required' => true,
                'choices' => [
            ...
            ->add('channel', FieldDescriptionInterface::TYPE_CHOICE, [
                ...
                'label' => 'Canal',
                'editable' => true,
                'class' => 'App\Oweb\Entity\ReservaChannel',
                'required' => true,
                'choices' => [
            ...
            ->add(ListMapper::NAME_ACTIONS, null, [
                ...
                'actions' => [
                    'show' => [],
                    'resumen' => [
                        'template' => 'oweb/admin/reserva_reserva/list__action_resumen.html.twig'
                    ],
                    'edit' => [],
                    'delete' => [],
                    'clonar' => [
                        'template' => 'oweb/admin/reserva_reserva/list__action_clonar.html.twig'
                    ],
                    'extender' => [
