...
class CuentaMovimientoAdmin extends AbstractSecureAdmin
{
    ...
    protected function configureListFields(ListMapper $listMapper): void
    {
        $listMapper
            ...
            ->add('debesoles', null, [
                'template' => 'oweb/admin/cuenta_movimiento/list_string_debesoles.html.twig',
                'label' => 'Ingreso Soles',
                'row_align' => 'right'
            ])
            ->add('habersoles', null, [
                'template' => 'oweb/admin/cuenta_movimiento/list_string_habersoles.html.twig',
                'label' => 'Egreso Soles',
                'row_align' => 'right'
            ])
            ->add('cobradorpagador', null, [
    ...
    protected function configureFormFields(FormMapper $formMapper): void
    {
        ...
        && $this->getRoot()->getClass() != 'App\Oweb\Entity\CuentaPeriodo'){
