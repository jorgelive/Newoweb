...
class TransporteServicioAdmin extends AbstractSecureAdmin
{
        ...
        $listMapper
             ->add(ListMapper::NAME_ACTIONS, 'actions', [
                 ...
                 'actions' => [
                    ...
                    'delete' => [],
                    'clonar' => [
                        'template' => 'oweb/admin/transporte_servicio/list__action_clonar.html.twig'
                    ]
                 ]
            ]);
    }
    ...
    protected function configureShowFields(ShowMapper $showMapper): void
    {
        ...
        $showMapper
            ...
            ->add('serviciooperativos', 'collection', [
                'template' => 'oweb/admin/transporte_servicio/show_serviciooperativo_collection.html.twig'
            ])
            ->end()
            ->with('Componentes')
            ->add('serviciocomponentes', 'collection', [
                'template' => 'oweb/admin/transporte_servicio/show_serviciocomponente_collection.html.twig'
            ])
            ->end()
        ;
    }
