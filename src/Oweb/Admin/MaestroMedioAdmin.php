...
class MaestroMedioAdmin extends AbstractSecureAdmin
{
    ...
    {
        $buttonList['carga'] = ['template' => 'oweb/admin/maestro_medio/carga_button.html.twig'];
    ...
    protected function configureListFields(ListMapper $listMapper): void
    {
        $listMapper
            ...
            ->add(ListMapper::NAME_ACTIONS, null, [
                ...
                'actions' => [
                    'copiar_url' => [
                        'template' => 'oweb/admin/maestro_medio/list__action_url_clipboard.html.twig',
                    ],
                    'show' => [],
                    'edit' => [],
                    'delete' => [],
                    'traducir' => [
                        'template' => 'oweb/admin/maestro_medio/list__action_traducir.html.twig',
                    ],
                ],
            ])
        ;
