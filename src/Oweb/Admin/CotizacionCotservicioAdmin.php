...
class CotizacionCotservicioAdmin extends AbstractSecureAdmin
{
    ...
    public function configure(): void
    {
        ...
        $this->setFormTheme([0 => 'oweb/admin/cotizacion_cotservicio/form_admin_fields.html.twig']);
    }
        ...
        $listMapper
            ...
            ->add(ListMapper::NAME_ACTIONS, null, [
                ...
                'actions' => [
                    ...
                    'edit' => [],
                    'delete' => [],'clonar' => [
                        'template' => 'oweb/admin/cotizacion_cotservicio/list__action_clonar.html.twig'
                    ]
                ]
            ])
        ;
    ...
    protected function configureFormFields(FormMapper $formMapper): void
    {
        if($this->getRoot()->getClass() != 'App\Oweb\Entity\CotizacionFile'
            ...
            && !($this->isCurrentRoute('edit') && $this->getRoot()->getClass() == 'App\Oweb\Entity\CotizacionCotservicio')
        ){
        ...
        $formMapper
            ->add('servicio', ModelAutocompleteType::class, [
                ...
                'route' => ['name' => 'api_oweb_servicio_servicio_alldropdown', 'parameters' => []],
                'placeholder' => '',
            ...
            ->add('itinerario', ModelAutocompleteType::class, [
                ...
                'template' => '/form/type/ajax_dropdown_type_cotizacion_base.html.twig',
                'route' => ['name' => 'api_oweb_servicio_itinerario_porserviciodropdown', 'parameters' => []],
                'placeholder' => '',
    ...
    {
        return 'app/cotizacioncotservicio';
    }
    ...
    {
        if($action == 'show'){
            $buttonList['cotizacionshow'] = ['template' => 'oweb/admin/cotizacion_cotservicio/cotizacionshow_button.html.twig'];
            $buttonList['clonar'] = ['template' => 'oweb/admin/cotizacion_cotservicio/clonar_button.html.twig'];
        }
        return $buttonList;
    }
