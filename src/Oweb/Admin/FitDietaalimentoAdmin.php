...
class FitDietaalimentoAdmin extends AbstractSecureAdmin
{
    ...
    {
        if($this->getRoot()->getClass() != 'App\Oweb\Entity\FitDieta'
            && $this->getRoot()->getClass() != 'App\Oweb\Entity\FitDietacomida'
        ){
