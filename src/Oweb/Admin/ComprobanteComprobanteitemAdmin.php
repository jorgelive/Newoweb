...
class ComprobanteComprobanteitemAdmin extends AbstractSecureAdmin
{
    ...
    {
        if($this->getRoot()->getClass() != 'App\Oweb\Entity\ComprobanteComprobante'){
        ...
        $formBuilder->addEventListener(
            ...
            function (FormEvent $event) use ($widthModifier) {
                if($event->getData()
                    && $this->getRoot()->getClass() == 'App\Oweb\Entity\ComprobanteComprobante'
                ){
