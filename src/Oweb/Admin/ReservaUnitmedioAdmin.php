...
class ReservaUnitmedioAdmin extends AbstractSecureAdmin
{
    ...
    {
        $buttonList['carga'] = ['template' => 'oweb/admin/reserva_unitmedio/carga_button.html.twig'];
        return $buttonList;
    }
        ...
        $list
            ...
            ->add(ListMapper::NAME_ACTIONS, null, [
                ...
                'actions' => [
                    ...
                    'delete' => [],
                    'traducir' => [
                        'template' => 'oweb/admin/reserva_unitmedio/list__action_traducir.html.twig'
                    ],
                ],
            ]);
    }
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        ...
        if ($this->getRoot()->getClass() != \App\Oweb\Entity\ReservaUnitcaracteristica::class) {
