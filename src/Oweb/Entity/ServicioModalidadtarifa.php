...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ServicioModalidadtarifaTranslation')]
class ServicioModalidadtarifa
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: ServicioModalidadtarifaTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
