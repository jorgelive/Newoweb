...
class ServicioProvider
{
    ...
    #[ORM\OneToMany(targetEntity: ServicioTarifa::class, mappedBy: 'provider', cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['nombre' => 'ASC'])]
    private Collection $tarifas;

    #[ORM\OneToMany(targetEntity: ServicioProvidermedio::class, mappedBy: 'provider', cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['prioridad' => 'ASC'])]
    private Collection $providermedios;

    #[ORM\OneToMany(targetEntity: CotizacionCottarifa::class, mappedBy: 'provider', cascade: ['persist', 'remove'], orphanRemoval: true)]
