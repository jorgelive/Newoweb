...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ReservaUnittipocaracteristicaTranslation')]
class ReservaUnittipocaracteristica
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: ReservaUnittipocaracteristicaTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: ReservaUnitcaracteristica::class, mappedBy: 'unittipocaracteristica', cascade: ['persist', 'remove'], orphanRemoval: true)]
