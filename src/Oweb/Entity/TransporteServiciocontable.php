...
class TransporteServiciocontable
{
     ...
     */
    #[ORM\ManyToOne(targetEntity: TransporteServicio::class, inversedBy: 'serviciocontables')]
     ...
     */
    #[ORM\ManyToOne(targetEntity: ComprobanteComprobante::class, inversedBy: 'serviciocontables')]
