...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ServicioTarifaTranslation')]
class ServicioTarifa
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: ServicioTarifaTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
     ...
     */
    #[ORM\ManyToOne(targetEntity: ServicioTipotarifa::class)]
     ...
     */
    #[ORM\ManyToOne(targetEntity: ServicioModalidadtarifa::class)]
     ...
     */
    #[ORM\ManyToOne(targetEntity: ServicioComponente::class, inversedBy: 'tarifas')]
     ...
     */
    #[ORM\ManyToOne(targetEntity: MaestroCategoriatour::class)]
     ...
     * @var MaestroTipopax
     */
    #[ORM\ManyToOne(targetEntity: MaestroTipopax::class)]
    protected $tipopax;

    /**
     * @var ServicioProvider
     */
    #[ORM\ManyToOne(targetEntity: ServicioProvider::class, inversedBy: 'tarifas')]
