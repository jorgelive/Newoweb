...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ServicioNotaitinerariodiaTranslation')]
class ServicioNotaitinerariodia
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: ServicioNotaitinerariodiaTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: ServicioItinerariodia::class, mappedBy: 'notaitinerariodia', cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['id' => 'ASC'])]
