...
class TransporteUnidad
{
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: TransporteServicio::class, mappedBy: 'unidad', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private $servicios;

    /**
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: TransporteUnidadbitacora::class, mappedBy: 'unidad', cascade: ['persist', 'remove'], orphanRemoval: true)]
     ...
     * @var CuentaCentro
     */
    #[ORM\OneToOne(targetEntity: CuentaCentro::class, mappedBy: 'unidad')]
    private $centro;
