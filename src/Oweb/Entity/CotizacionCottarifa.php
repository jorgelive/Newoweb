...
class CotizacionCottarifa
{
    ...
    #[ORM\ManyToOne(targetEntity: ServicioProvider::class, inversedBy: 'cottarifas')]
    #[ORM\JoinColumn(name: 'provider_id', referencedColumnName: 'id', nullable: true)]
    protected ?ServicioProvider $provider = null;

    #[ORM\ManyToOne(targetEntity: ServicioTarifa::class)]
    ...
    #[ORM\OneToMany(
        mappedBy: 'cottarifa',
        targetEntity: CotizacionCottarifadetalle::class,
