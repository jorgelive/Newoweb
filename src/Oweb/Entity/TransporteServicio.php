...
#[ORM\Entity(repositoryClass: 'App\Oweb\Repository\TransporteServicioRepository')]
class TransporteServicio
{
     ...
     */
    #[ORM\ManyToOne(targetEntity: TransporteUnidad::class, inversedBy: 'servicios')]
     ...
     */
    #[ORM\ManyToOne(targetEntity: TransporteConductor::class, inversedBy: 'servicios')]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: TransporteServiciocontable::class, mappedBy: 'servicio', cascade: ['persist', 'remove'], orphanRemoval: true)]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: TransporteServiciocomponente::class, mappedBy: 'servicio', cascade: ['persist', 'remove'], orphanRemoval: true)]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: TransporteServiciooperativo::class, mappedBy: 'servicio', cascade: ['persist', 'remove'], orphanRemoval: true)]
