...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\MaestroClasemedioTranslation')]
class MaestroClasemedio
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: MaestroClasemedioTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: MaestroMedio::class, mappedBy: 'clasemedio', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private $medios;
