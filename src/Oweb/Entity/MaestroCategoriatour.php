...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\MaestroCategoriatourTranslation')]
class MaestroCategoriatour
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(targetEntity: MaestroCategoriatourTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
