...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ServicioComponenteitemTranslation')]
class ServicioComponenteitem
{
    ...
    #[ORM\OneToMany(mappedBy: 'object', targetEntity: ServicioComponenteitemTranslation::class, cascade: ['persist', 'remove'])]
    ...
    #[ORM\ManyToOne(targetEntity: ServicioComponente::class, inversedBy: 'componenteitems')]
