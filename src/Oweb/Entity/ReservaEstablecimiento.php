...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ReservaEstablecimientoTranslation')]
class ReservaEstablecimiento implements Translatable
{
     ...
     */
    #[ORM\OneToMany(targetEntity: ReservaUnit::class, mappedBy: 'establecimiento', cascade: ['persist', 'remove'], orphanRemoval: true)]
     ...
     */
    #[ORM\OneToMany(targetEntity: ReservaEstablecimientoTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'], orphanRemoval: true)]
