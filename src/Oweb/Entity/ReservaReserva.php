...
#[ORM\Entity(repositoryClass: 'App\Oweb\Repository\ReservaReservaRepository')]
class ReservaReserva
{
    ...
    #[ORM\ManyToOne(targetEntity: ReservaChannel::class, inversedBy: 'reservas')]
    #[ORM\JoinColumn(name: 'channel_id', referencedColumnName: 'id', nullable: false)]
    private ?ReservaChannel $channel;

    #[ORM\ManyToOne(targetEntity: ReservaUnitnexo::class, inversedBy: 'reservas')]
    #[ORM\JoinColumn(name: 'unitnexo_id', referencedColumnName: 'id', nullable: true)]
    private ?ReservaUnitnexo $unitnexo;

    #[ORM\ManyToOne(targetEntity: ReservaUnit::class, inversedBy: 'reservas')]
    #[ORM\JoinColumn(name: 'unit_id', referencedColumnName: 'id', nullable: false)]
    private ?ReservaUnit $unit;

    #[ORM\ManyToOne(targetEntity: ReservaEstado::class, inversedBy: 'reservas')]
    #[ORM\JoinColumn(name: 'estado_id', referencedColumnName: 'id', nullable: false)]
    private ?ReservaEstado $estado;

    #[ORM\OneToMany(targetEntity: ReservaDetalle::class, mappedBy: 'reserva', cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['id' => 'ASC'])]
    private Collection $detalles;

    #[ORM\OneToMany(targetEntity: ReservaImporte::class, mappedBy: 'reserva', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $importes;

    #[ORM\OneToMany(targetEntity: ReservaPago::class, mappedBy: 'reserva', cascade: ['persist', 'remove'], orphanRemoval: true)]
