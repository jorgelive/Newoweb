...
class ReservaUnitnexo
{
     ...
     * @var ReservaChannel
     */
    #[ORM\ManyToOne(targetEntity: ReservaChannel::class, inversedBy: 'unitnexos')]
     ...
     * @var ReservaUnit
     */
    #[ORM\ManyToOne(targetEntity: ReservaUnit::class, inversedBy: 'unitnexos')]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: ReservaReserva::class, mappedBy: 'unitnexo', cascade: ['persist', 'remove'])]
    private $reservas;
