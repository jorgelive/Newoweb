...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ServicioItinerariodiaTranslation')]
class ServicioItinerariodia
{
    ...
    #[ORM\OneToMany(targetEntity: ServicioItinerariodiaTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
    protected Collection $translations;

    #[ORM\ManyToOne(targetEntity: ServicioItinerario::class, inversedBy: 'itinerariodias')]
    ...
    #[ORM\OneToMany(targetEntity: ServicioItidiaarchivo::class, mappedBy: 'itinerariodia', cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['prioridad' => 'ASC'])]
    private Collection $itidiaarchivos;

    #[ORM\ManyToOne(targetEntity: ServicioNotaitinerariodia::class, inversedBy: 'itinerariodias')]
