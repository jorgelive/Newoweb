...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ServicioItinerarioTranslation')]
class ServicioItinerario
{
     ...
     * @var ArrayCollection
     */
    #[ORM\OneToMany(mappedBy: 'object', targetEntity: ServicioItinerarioTranslation::class, cascade: ['persist', 'remove'])]
    ...
    /**
     * @var ServicioServicio
     */
    #[ORM\ManyToOne(targetEntity: ServicioServicio::class, inversedBy: 'itinerarios')]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(mappedBy: 'itinerario', targetEntity: ServicioItinerariodia::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
     ...
     * Set servicio
     *
     * @param ServicioServicio $servicio
     *
     * @return ServicioItinerario
     */
    public function setServicio(ServicioServicio $servicio = null)
    {
     ...
     * @param ServicioItinerariodia $itinerariodia
     */
    public function removeItinerariodia(ServicioItinerariodia $itinerariodia)
    {
