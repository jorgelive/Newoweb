...
#[ORM\Entity]
#[Gedmo\TranslationEntity(class: 'App\Oweb\Entity\ReservaUnitTranslation')]
class ReservaUnit
{
    ...
    #[ORM\OneToMany(targetEntity: ReservaUnitTranslation::class, mappedBy: 'object', cascade: ['persist', 'remove'])]
    ...
    #[ORM\ManyToOne(targetEntity: ReservaEstablecimiento::class, inversedBy: 'units')]
    ...
    #[ORM\OneToMany(targetEntity: ReservaReserva::class, mappedBy: 'unit', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $reservas;

    #[ORM\OneToMany(targetEntity: ReservaUnitnexo::class, mappedBy: 'unit', cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $unitnexos;

    /**
     * Vínculos Unit–Característica (M2M con prioridad en el vínculo)
     */
    #[ORM\OneToMany(targetEntity: ReservaUnitCaracteristicaLink::class, mappedBy: 'unit', cascade: ['persist', 'remove'], orphanRemoval: true)]
