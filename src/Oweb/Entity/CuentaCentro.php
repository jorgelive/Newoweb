...
class CuentaCentro
{
     ...
     */
    #[ORM\OneToOne(targetEntity: TransporteUnidad::class, inversedBy: 'centro')]
     ...
     * @var Collection
     */
    #[ORM\OneToMany(targetEntity: CuentaMovimiento::class, mappedBy: 'centro', cascade: ['persist', 'remove'], orphanRemoval: true)]
