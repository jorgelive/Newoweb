...
class FullcalendarExtension extends AbstractExtension
{
     ...
     * EVENTOS – URL absoluta según host definido en routing
     */
    public function generateUrl($calendar): ?string
    {
     ...
     * RESOURCES – URL absoluta según host definido en routing
     */
    public function generateResourceUrl($calendar): ?string
    {
     ...
     * Render principal del FullCalendar
     */
    public function fullcalendar($caller, $calendars, $defaultView = null, $views = [], $allDaySlot = false): string
    {
        if (empty($views)) {
            ...
            customButtons: {
                hoyButton: {
                    ...
                    click: function() {
                        ...
                        if (String(calendar.view.type || '').startsWith('resourceTimeline')) {
            ...
            views: {
                ...
                resourceTimelineTwoMonths: {
                    ...
                    slotLabelContent(arg) {
                        ...
                        // FullCalendar pasa `arg.date` como Date real.
                        const d = arg.date;
...
JS;
        ...
        return <<<HTML
    <style>
      /* Evita que los labels del timeline partan a 2 líneas (Scheduler) */
      ...
      .fc .fc-timeline-slot-frame { overflow: hidden; }
      /* Refuerzo anti-wrap: algunos temas ponen display:flex en el cushion */
      .fc .fc-timeline-slot-cushion {
