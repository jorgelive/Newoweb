...
class OperacionServicio
{
     ...
     *
     * ⚠️ Antes lo resolvía el navegador **en vivo** contra el maestro, con el mismo `catch` que ya
     * borró el nombre del componente —y el getter que daba ese id se retiró con él—.
