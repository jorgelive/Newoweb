 ...
 */
#[AsEntityListener(event: Events::preUpdate, method: 'preUpdate', entity: TravelOrganizacionServicioImagen::class)]
#[AsEntityListener(event: Events::preRemove, method: 'preRemove', entity: TravelOrganizacionServicioImagen::class)]
class TravelOrganizacionServicioImagenCacheListener extends AbstractCacheListener
{
    /**
