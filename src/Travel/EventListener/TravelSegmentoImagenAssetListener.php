...
/**
 * Escucha los eventos de carga de la entidad TravelSegmentoImagen para inyectar
 * la URL pública de la imagen en la propiedad virtual $imageUrl, utilizando
 * el parámetro centralizado del sistema.
 */
#[AsEntityListener(event: Events::postLoad, method: 'postLoad', entity: TravelSegmentoImagen::class)]
#[AsEntityListener(event: Events::postPersist, method: 'postPersist', entity: TravelSegmentoImagen::class)]
#[AsEntityListener(event: Events::postUpdate, method: 'postUpdate', entity: TravelSegmentoImagen::class)]
class TravelSegmentoImagenAssetListener extends AbstractAssetListener
{
    /**
