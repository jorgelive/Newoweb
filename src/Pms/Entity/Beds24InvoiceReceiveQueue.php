...
use App\Pms\Repository\Beds24InvoiceReceiveQueueRepository;
 ...
 * una reserva Beds24. Espejo de App\Message\Entity\Beds24ReceiveQueue.
 *
 * Las FKs a Beds24Config y ExchangeEndpoint son UNIDIRECCIONALES (sin inversedBy) a
 * propósito, para no tener que añadir colecciones inversas en esas entidades del módulo
 * Exchange.
 */
#[ORM\Entity(repositoryClass: Beds24InvoiceReceiveQueueRepository::class)]
#[ORM\Table(name: 'pms_beds24_invoice_receive_queue')]
#[ORM\Index(columns: ['status', 'run_at'], name: 'idx_pms_invoice_receive_worker')]
#[ORM\HasLifecycleCallbacks]
class Beds24InvoiceReceiveQueue implements ExchangeQueueItemInterface, TargetBookAwareInterface, MemoryCleanableInterface
{
    use IdTrait;
    use TimestampTrait;
