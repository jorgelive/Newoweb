 ...
 *
 * Mismo patrón que {@see PmsGuiaItemGaleriaAssetListener}, y por el mismo motivo: la ruta pública
 * es configuración (`pms.path.unidad_images`), así que no puede vivir dentro de la entidad. Sin
 * este listener, `PmsUnidadMedia::getValor()` devolvería el nombre del archivo
 * —`TOKEN_croquis.webp`— y la guía pintaría una imagen rota.
 *
 * Su gemelo es {@see PmsUnidadMediaCacheListener}, que tira la miniatura cuando el medio cambia.
 */
