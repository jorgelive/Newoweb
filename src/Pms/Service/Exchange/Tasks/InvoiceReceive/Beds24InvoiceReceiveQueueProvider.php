...
final readonly class Beds24InvoiceReceiveQueueProvider implements ExchangeQueueProviderInterface
{
    public function __construct(private Beds24InvoiceReceiveQueueRepository $repository) {}
