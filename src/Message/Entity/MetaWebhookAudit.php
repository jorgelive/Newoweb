...
/**
 * Entidad MetaWebhookAudit.
 * Registra y audita todas las notificaciones entrantes desde el Webhook de Meta (WhatsApp).
...
class MetaWebhookAudit
{
    ...
    {
        return 'MetaWebhookAudit #' . ($this->getId() ?? 'NEW') . ' [' . $this->status . ']';
    }
    ...
    // =========================================================================
    // MÉTODOS VIRTUALES (Para UI en EasyAdmin o Logs)
    // =========================================================================
