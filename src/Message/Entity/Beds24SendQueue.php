...
class Beds24SendQueue implements MessageQueueItemInterface, TargetBookAwareInterface, MemoryCleanableInterface, VetoableQueueItemInterface
{
    ...
    {
        return $this->message ?? throw new \LogicException('Cola Beds24SendQueue sin mensaje (la columna es NOT NULL).');
    }
    ...
    public function getSendTaskName(): string { return 'beds24_message_send'; }
