  ...
  <div class="min-h-screen bg-slate-50 flex flex-col font-sans">
    ...
    <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between sticky top-0 z-30 shadow-sm">
      ...
      <button @click="nuevaVersion" class="px-5 py-2.5 bg-[#376875] hover:bg-[#2d5662] text-white font-bold rounded-xl shadow-md transition-all flex items-center gap-2">
        <i class="fas fa-rocket"></i> <span>Crear Nueva Versión</span>
      </button>
    </header>
    ...
    <main v-else class="flex-1 p-6 md:p-8 max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-8">
